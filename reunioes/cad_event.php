...
$query_event = "INSERT INTO events (title, color, start, end, sala, nome_usuario) VALUES (:title, :color, :start, :end,:sala,:nome_usuario)";
...
$insert_event->bindParam(':nome_usuario', $dados['nome_usuario']);
